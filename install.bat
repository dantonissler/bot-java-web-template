call mvn install:install-file -Dfile=lib/botcity-framework-core-1.5.0.jar -DgroupId=dev.botcity -DartifactId=botcity-framework-core -Dversion=1.5.0 -Dpackaging=jar
