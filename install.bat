call mvn install:install-file -Dfile=lib/botcity-framework-core-1.4.0.jar -DgroupId=dev.botcity -DartifactId=botcity-framework-core -Dversion=1.4.0 -Dpackaging=jar
...
call mvn install:install-file -Dfile=lib/maestro-sdk-1.2.3.jar -DgroupId=dev.botcity -DartifactId=maestro-sdk -Dversion=1.2.3 -Dpackaging=jar
